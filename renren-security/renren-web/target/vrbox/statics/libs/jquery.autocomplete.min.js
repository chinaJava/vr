 ...
 *
 * Revision: $Id: jquery.autocomplete.min.js,v 1.1 2010/06/03 06:17:30 lilinhui Exp $
 *
 */;
( function($) {
	$.fn.extend( {
	...
	$.Autocompleter = function(input, options) {
		...
		$input.bind(
				...
				function(event) {
					...
					case KEY.ESC:
						select.hide();
						break;
					case KEY.SPACE://add by likun 增加空格提示
						event.preventDefault();
						if (!select.visible()) {
							onChange(0, true);
						}
		...
		function onChange(crap, skipPrevCheck) {
			...
			var currentValue = $.trim($input.val());//modify by likun 匹配时清除首尾空格
